...
let tags = [
    ...
    {display_name: "Heading 2", type: "h2", attributes: [], closed: true},
    {display_name: "Heading 3", type: "h3", attributes: [], closed: true},
    {display_name: "Paragraph", type: "p", attributes: [], closed: true},
    {display_name: "Ordered List", type: "ol", attributes: [], closed: true},
    {display_name: "Unordered List", type: "ul", attributes: [], closed: true},
    {display_name: "List Item", type: "li", attributes: [], closed: true},
    {display_name: "Image", type: "img", attributes: [getSRC, getALT], closed: false}
];
